...
def test_get_kenya():
    ...
    """
    assert get_country_details("Kenya") == {'capital': 'Nairobi', 'country': 'Kenya', 'id': 1, 'leader': 'William Ruto', 'population': 55678333}

def test_get_rwanda():
    """
    Function to test get method
    """
    assert get_country_details("Rwanda") == {'capital': 'Kigali', 'country': 'Rwanda', 'id': 4, 'leader': 'Paul Kagame', 'population': 19678975}
